        ...
        <nav class="container mx-auto px-4">
            <div class="hidden md:block">
                ...
                <ul v-else class="flex flex-row gap-4 justify-start py-4">
                    <li><router-link to="/">Sustav za upravljanje kolegijima</router-link></li>
                </ul>
            </div>
            ...
            <div class="flex md:hidden p-4 justify-end">
                <div>
                    <button @click="toggleMenu" value="hamburger"
                        class="flex flex-col justify-around h-8 w-8 p-2 rounded hover:bg-gray-400">
                ...
                <div v-if="isOpened"
                    class="text-2xl z-10 absolute inset-0 bg-slate-200 flex flex-col gap-4 text-slate-900 text-center">
